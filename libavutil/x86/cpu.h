...
#define X86_AMD3DNOW(flags)         0//CPUEXT(flags, AMD3DNOW)
#define X86_AMD3DNOWEXT(flags)      0//CPUEXT(flags, AMD3DNOWEXT)
...
#define EXTERNAL_AMD3DNOW(flags)    0//CPUEXT_SUFFIX(flags, _EXTERNAL, AMD3DNOW)
#define EXTERNAL_AMD3DNOWEXT(flags) 0//CPUEXT_SUFFIX(flags, _EXTERNAL, AMD3DNOWEXT)
...
#define INLINE_AMD3DNOW(flags)      0//CPUEXT_SUFFIX(flags, _INLINE, AMD3DNOW)
#define INLINE_AMD3DNOWEXT(flags)   0//CPUEXT_SUFFIX(flags, _INLINE, AMD3DNOWEXT)
