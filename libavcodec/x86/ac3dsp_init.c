...
void ff_ac3_extract_exponents_sse2 (uint8_t *exp, const int32_t *coef, int nb_coefs);
void ff_ac3_extract_exponents_ssse3(uint8_t *exp, const int32_t *coef, int nb_coefs);
